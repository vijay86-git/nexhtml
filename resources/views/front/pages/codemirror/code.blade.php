...
<head>
	...
	<script type="text/javascript" src="{{ URL::asset('codemirror/lib/bin/mode/htmlmixed.js?v=1') }}"></script>
	<script type="text/javascript" src="{{ URL::asset('codemirror/lib/bin/js/active-line.js?v=1') }}"></script>
