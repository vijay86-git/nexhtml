...
you use this, in a case of an error in the
...
<script src="https://nexladder.com/build/assets/js/jquery-3.2.1.min.js?v=1"></script>
<!-- Include all compiled plugins (below), or include individual files as needed -->
<script src="https://nexladder.com/build/assets/js/bootstrap.min.js?v=1"></script>
</body>
</html>