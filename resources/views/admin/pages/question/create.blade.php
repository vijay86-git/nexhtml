      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            {!! Form::open(['route' => 'question.store', 'role' => 'form', 'autocomplete' => 'off', 'files' => true]) !!}
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <select class="form-control" name="label_id">
                    ...
                    @foreach ($labels as $label)
                      <option value="{{ $label->id }}">{{ $label->interview_label }}</option>
                    @endforeach
                  </select>
                ...
                <div class="form-group">
                  ...
                  <input class="form-control" name="question" placeholder="Question" type="text" value="{{ old('question') }}">
                </div>
                ...
                <div class="form-group">
                  ...
                  <textarea id="editor1" class="form-control" name="answer" id="answer" placeholder="Enter Answer">{{ old('answer') }}</textarea>
                </div>
