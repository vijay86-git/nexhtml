      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            {!! Form::open(['route' => 'topic.store', 'role' => 'form', 'autocomplete' => 'off', 'files' => true]) !!}
              ...
              <div class="box-body">
               ...
               <!-- <div class="form-group">
                  ...
                  <textarea id="editor1" class="form-control" name="description" id="description" placeholder="Enter Topic Description">{{ old('description') }}</textarea>
                </div>-->

                <div class="form-group">
                  <label for="page_title">Description&nbsp;<span class="req">*</span></label>
                
                  <textarea style="height: 150px" id="" class="form-control" name="description" id="description" placeholder="Enter Topic Description">{{ old('description') }}</textarea>
                </div>
