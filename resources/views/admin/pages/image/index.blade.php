            ...
            <div class="box-body">
               ...
               @foreach ($images as $data)
                    ...
                    <div class="col-sm-3" style="margin:10px 0">
                      <img class="img-responsive" src="{{ UPLOAD_PATH.$data->image_url }}" alt="Photo">
                      <input type="text" id="text_{{ $data->id }}" class="url" value="{{ UPLOAD_PATH.$data->image_url }}" /><button type="button" class="btn btn-success btn-flat btn-sm cstm" data-attr="{{ $data->id }}" onclick="copyContent({{ $data->id }})">Copy</button>
                    </div>
