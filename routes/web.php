...
Route::group(array('domain' => 'cp.nexladder.com', 'namespace' => 'Admin', 'middleware' => 'ip:106.211.*'), function() {
...
Route::get('/subjects.json', array('as' => 'subjects.api', 'uses' => 'TopicController@getSubjects'));
